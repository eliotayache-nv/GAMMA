...
static double rmax    = 1000.;         // light-seconds, box upper boundary at t_ini
...
void loadParams(s_par *par){
  ...
  par->ncell[y_] = 50;               // number of cells in theta direction
  par->nmax      = 250;              // max number of cells in MV direction
...
int Grid::checkCellForRegrid(int j, int i){
  ...
  double target_AR  = pow(rmax/r, 0.2);                   // set target aspect ratio
